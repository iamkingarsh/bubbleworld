...
import { ArrowSmallRightIcon, LinkIcon } from '@heroicons/react/24/solid';
            ...
            <div className='container'>
                ...
                <div className="right">
                    ...
                    <motion.video initial={{ y: 50, opacity: 0 }}
                        whileInView={{ y: 0, opacity: 100 }}
                        transition={{ type: "spring", stiffness: 100, duration: 1, ease: "linear", }} controls={true} className='video-frame' src="https://bubbleworld.site/assets/videos/video01.mp4?v=87f0ea9c"></motion.video>
                </div>
            </div>
        </div>
    )
